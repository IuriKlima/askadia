  ...
  return <div className={styles.site}>
    ...
    <main id="conteudo">
      ...
      <section id="possibilidades" className={styles.features} aria-labelledby="recursos-titulo">
        ...
        <div className={styles.evolution}><Sparkles size={22} strokeWidth={1.5} aria-hidden="true"/><div><h3>Uma visão maior, em construção.</h3><p>A OpenAI apoia a conversa e propõe estratégia e tráfego pago. Design com Nano Banana Pro, publicação e atendimento conectado seguem em implantação; gerar uma proposta não ativa anúncios.</p></div><span className={styles.status}>Em desenvolvimento</span></div>
      </section>
